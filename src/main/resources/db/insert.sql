...
INSERT  INTO PLACE (id, country, city, latitude, longitude)
SELECT 1, 'Unknown place', 'Unknown place', 0.0, 0.0
  WHERE NOT EXISTS (SELECT id, country, city, latitude, longitude from Place where id = 1);
