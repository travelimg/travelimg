...
CREATE TABLE IF NOT EXISTS Slide(id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, photo_id INTEGER REFERENCES Photo(id), slideshow_id INTEGER REFERENCES Slideshow(id), orderposition INTEGER NOT NULL);
