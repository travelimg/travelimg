...
CREATE TABLE Exif(photo_id INTEGER REFERENCES Photo(id), date TIMESTAMP NOT NULL, exposure VARCHAR NOT NULL, aperture DOUBLE NOT NULL, focallength DOUBLE NOT NULL, iso INTEGER NOT NULL, flash BOOLEAN NOT NULL, cameramodel VARCHAR NOT NULL, longitude VARCHAR NOT NULL, latitude DOUBLE NOT NULL, altitude DOUBLE NOT NULL);
