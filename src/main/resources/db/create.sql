...
CREATE TABLE IF NOT EXISTS Place(id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, city VARCHAR NOT NULL, country VARCHAR NOT NULL);
...
CREATE TABLE IF NOT EXISTS Photo(id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, photographer_id INTEGER REFERENCES Photographer(id), path VARCHAR NOT NULL, rating INTEGER NOT NULL DEFAULT 0, datetime TIMESTAMP NOT NULL, latitude DOUBLE NOT NULL, longitude DOUBLE NOT NULL, place_id INTEGER REFERENCES place(id));
