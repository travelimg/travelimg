...
public interface ExifService {
    ...
    /**
     * Reads and sets the tags from a photo which are saved in the user comment entry in the exif data
     *
     * @param photo the photo, must have a valid path
     * @throws ServiceException
     */
    ...
    /**
     * Sets the tags from a photo to the user comment entry in the exif data of the photofile
     *
     * @param photo the photo, must have a valid path
     * @throws ServiceException
     */
    public void exportTagsToExif(Photo photo) throws ServiceException;
